...
<div class="card">
  ...
  <a href="mein3d-slideshow.html" target="_blank" style="display:block; position:relative; border-radius:12px; overflow:hidden; max-width:700px; margin:0 auto;">
    <img src="images/mein3d-thumb.png" style="width:100%; display:block; border-radius:12px; box-shadow: 0 4px 14px rgba(255,105,180,0.25);">
