...
<div class="card" style="text-align:center; padding: 24px;">
  <p style="margin-bottom:16px;">Browse all 33 slides — click to expand fullscreen, use arrow keys to navigate.</p>
  <a class="btn" href="mein3d-slideshow.html" target="_blank">🎞️ Open Interactive Presentation</a>
</div>